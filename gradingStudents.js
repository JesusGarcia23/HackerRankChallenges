...
// If the difference between the  and the next multiple of  is less than 3, round grade up to the next multiple of .
...
function gradingStudents(grades) {
  ...
  for(let i = 0; i < grades.length; i++) {
    let isGreaterThanTwo = Math.ceil(grades[i]/5)*5 - grades[i]
    if(grades[i] > 35 && isGreaterThanTwo <= 2) {
